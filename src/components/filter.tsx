...
const Filter = ({ languages }: any) => {
  ...
  const applyFilters = (e: any) => {
    ...
    updateSelectedFilter({ ...check, language: selectedLanguage });
  ...
  return (
    <div className="2xl:container 2xl:mx-auto">
      ...
      <div
        id="filterSection"
        className={
          "relative md:py-10 lg:px-20 md:px-6 py-9 px-4 dark:bg-zinc-900 bg-gray-300 w-full "
        }
      >
        {/* Cross button Code  */}
        <div
        ...
        >
          <svg
            className=" lg:w-6 lg:h-6 w-4 h-4 stroke-zinc-900 dark:stroke-slate-200"
            viewBox="0 0 26 26"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            ...
            <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-start">
              ...
              <div className=" inline-block">
                <div className=" flex space-x-6 justify-center items-center">
                  <label
                    className=" mr-2 text-sm leading-3 font-normal flex items-center gap-2 cursor-pointer"
                    htmlFor="movie"
                  >
                    {movie ? (
                      <FilmStrip size={32} weight="fill" />
                    ) : (
                      <FilmStrip size={32} />
                    )}
                    Filme
            ...
            <div className=" flex justify-center items-center">
              ...
              <div className=" inline-block">
                <div className=" flex space-x-6 justify-center items-center">
                  ...
                  >
                    {serie ? (
                      <Television size={32} weight="fill" />
                    ) : (
                      <Television size={32} />
                    )}
                    Série
        ...
        <div className="px-0 mt-10 w-full md:w-auto md:mt-0 md:absolute md:right-0 md:bottom-0 md:py-10 lg:px-20 md:px-6">
          <button
            ...
            className="w-full hover:bg-red-700 focus:ring focus:ring-offset-2 focus:ring-red-800 text-base leading-4 font-medium py-4 px-10 text-white bg-red-600 border"
          >
            Salvar filtro
          </button>
        </div>
