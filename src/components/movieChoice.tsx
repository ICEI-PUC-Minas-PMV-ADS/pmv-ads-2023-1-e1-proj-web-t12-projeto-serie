...
export default function MovieChoice() {
  ...
  useEffect(() => {
    if (firstOption === "" && secondOption === "") {
      setfirstOption(
        themes.sort_by[Math.floor(Math.random() * themes.sort_by.length)]
      );
      setsecondOption(
        themes.sort_by[Math.floor(Math.random() * themes.sort_by.length)]
      );
  ...
  const fillMatch = (idx: number) => {
    ...
    switch (count) {
      case 0: // sort_by
        ...
        setfirstOption(
          themes.vote_average[
            Math.floor(Math.random() * themes.vote_average.length)
          ]
        );
        setsecondOption(
          themes.vote_average[
            Math.floor(Math.random() * themes.vote_average.length - 1)
          ]
        );
        break;
      ...
      case 1: // vote_average
        ...
        setfirstOption(
          themes.genre[Math.floor(Math.random() * themes.genre.length)]
        );
        setsecondOption(
          themes.genre[Math.floor(Math.random() * themes.genre.length - 1)]
        );
        break;
      ...
      case 2: // genre
        ...
        setfirstOption(
          themes.without_genres[
            Math.floor(Math.random() * themes.without_genres.length)
          ]
        );
        setsecondOption(
          themes.without_genres[
            Math.floor(Math.random() * themes.without_genres.length - 1)
          ]
        );
        break;
      ...
      case 3: // without_genres
        ...
        setTopic("Ano");
        setfirstOption(
          themes.year[Math.floor(Math.random() * themes.year.length)]
        );
        setsecondOption(
          themes.year[Math.floor(Math.random() * themes.year.length - 1)]
        );
        break;
  ...
  const getMatchResults = async () => {
    const responseMovies = await fetch(
      "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=true&language=pt-BR&page=1" +
        "&sort_by=" +
        sort_by +
        "&vote_average.lte=" +
        vote_average +
  ...
  return (
    <div>
            ...
            <div className="flex items-center">
              <div className="flex justify-start w-full">
                <h2 style={{ textAlign: "left" }}>
                  <strong>Qual você prefere?</strong>
                </h2>
              </div>
      ...
      <div className="w-full flex flex-col">
        ...
        ) : movie !== undefined && serie !== undefined ? (
          <div>
            <div
